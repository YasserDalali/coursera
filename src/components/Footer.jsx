            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        <div className="w-32 h-12 bg-gray-200 flex items-center justify-center mb-4">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link to="/reservations" className="hover:text-yellow-500">Reservations</Link></li>
                            <li><Link to="/order-online" className="hover:text-yellow-500">Order Online</Link></li>
                ...
                <div className="mt-8 border-t border-gray-700 pt-8 text-center">
                    <p className="text-sm">&copy; {new Date().getFullYear()} Little Lemon Restaurant. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
